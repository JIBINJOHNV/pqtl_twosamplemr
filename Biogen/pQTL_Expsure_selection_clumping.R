...
#/edgehpc/dept/human_genetics/users/jjohn1/Cis_Trans/Exposure/UKB_50KClimped/Reanalysis/All_Biogen_Exposure_TSS_chr_index_3k_Part1.csv"

files_df <- fread("All_Biogen_Exposure_TSS_chr_index_3k_Part1.csv")
