...
prefix="trans_exposure_NoMHC_Unique"
...
#Rscript Decode_TransExposure_NoMHC_Unique_twosampleMR_Running.R
#sbatch TransExposure_NoMHC_Unique_mr_analysis_sbatch_command.sh
