...
exposure_file<-"All_significannt_trans_exposure_AfterQC_LDclumping.csv"


set_bcftools('/home/jjohn1/modulefiles/anaconda3/bin/bcftools')
set_plink('/home/jjohn1/modulefiles/Softwares/Plink/plink')

outcomevcf="/edgehpc/dept/human_genetics/users/jjohn1/Outcome_GWAS/PGC3_SCZ/PGC3_SCZ_wave3.european.autosome.public.v3_hg38_rsid156_nodup.vcf.gz"
outcomevcf_index="/edgehpc/dept/human_genetics/users/jjohn1/Outcome_GWAS/PGC3_SCZ/PGC3_SCZ_wave3.european.autosome.public.v3_hg38_rsid156.vcf.index"
...
# srun -n 2 --mem=8G --time=2:01:00 --pty bash ##For tsting time only 
# module load libxml2/2.9.8-GCCcore-6.4.0
# module load OpenSSL/1.1
# module load R/4.1.3-foss-2021b
# module load GMP/6.2.1-GCCcore-11.2.0
#Rscript Decode_TransExposure_twosampleMR_Running.R
#sbatch TransExposure_mr_analysis_sbatch_command.sh
