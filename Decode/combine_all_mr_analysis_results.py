...
dirction=dirction.drop_duplicates()
...
mr_het_ple_dir=mr_het_ple_dir.drop_duplicates()
...
mrpipelie=mrpipelie.drop_duplicates()
...
mr_pipeline_result=mr_pipeline_result.drop_duplicates()
...
MRAlltest_Result_df=MRAlltest_Result_df.drop_duplicates()
...
MRIVWtest_df=MRIVWtest_df.drop_duplicates()
...
MRPRESSO_raw_df=MRPRESSO_raw_df.drop_duplicates()
...
Final_mrResults=Final_mrResults.drop_duplicates()
Final_mrResults.to_csv("Cis_exposure_CompleteMR_AnalysisResults.csv",index=None)
...
mrpipelie2=mrpipelie2.drop_duplicates()
