...
exposure_files<- c("All_significannt_exposure_AfterQC_LDclumping_MHCRemoval.csv")      #c("All_significannt_exposure_AfterQC_LDclumping.csv")
prefix="Phosphate_withoutMHC"

set_bcftools('/home/jjohn1/modulefiles/anaconda3/bin/bcftools')
set_plink('/home/jjohn1/modulefiles/Softwares/Plink/plink')

outcomevcf="/edgehpc/dept/human_genetics/users/jjohn1/Outcome_GWAS/All_Processed_Outcome_GWAS_UniqIds/pgcAN2.2019-07_GRCh38_UniqID.vcf.gz"
outcomevcf_index="/edgehpc/dept/human_genetics/users/jjohn1/Outcome_GWAS/All_Processed_Outcome_GWAS_UniqIds/pgcAN2.2019-07_GRCh38_UniqID.vcf.vcf.index"
...
for ( Exposure in exposure_file ) {
        ...
        tryCatch({
            ...
            exposure_selected_df <- exposure_df
        }, error = function(e) {})
