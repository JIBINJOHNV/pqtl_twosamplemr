...
cis_Positive=df_filtered[ (df_filtered$`CIS.TRANS`=="CIS"), ] # TRANS ,CIS
...
ggsave(glue("All_phenotype_{pqtl_type}_{Direction}Direction_shapePvalue_ColorPvalue_NP0.01_onlyGT2_All_CIS.pdf"), plot = p, device = "pdf", width = 5, height = 12)
