...
df_filtered=read.csv("Alll_pheeotype_cis_trans_bonf_cog_beta_reversed_01_GT2.csv")

#df_filtered$Estimate_Direction <- ifelse(df_filtered$Phenotype == "CTP" & df_filtered$Direction == "+", "-", 
#                                          ifelse(df_filtered$Phenotype == "CTP" & df_filtered$Direction == "-", "+",
#                                                  df_filtered$Direction))
