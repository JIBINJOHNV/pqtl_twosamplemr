...
result_2df=result_df[['Approved symbol','Outcome','CIS/TRANS','Estimate_Direction','Lowest_Pvalue','DECODE_Estimate','UKBB_PPP_Estimate','CHR', 'Gene_start', 'Gene_end']].drop_duplicates()
